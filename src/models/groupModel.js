...
async function getAllGroups() {
  ...
  return await pool.query(`
    SELECT g.group_id, g.group_name, g.owner_id, u.email AS owner_name, g.created_at
    FROM groups g
...
module.exports = { createGroupToDb, addGroupAdmin, getAllGroups, fetchGroupDetails, deleteGroupFromDb };